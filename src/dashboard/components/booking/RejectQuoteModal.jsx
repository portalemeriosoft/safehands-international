            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        ...
                        <div className="mt-4">
                          <div className="relative">
                            ...
                            <label htmlFor="message" className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                              Are you sure you want to reject this quotation? If you have specific reasons, please provide details below to help us improve our service.
                            </label>
                            <textarea 
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  >
                    {quoteLoading ? "Sending.." : "Yes, reject"}
                  </button>
                  <button
                    type="button"
