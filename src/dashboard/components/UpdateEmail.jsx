...
export default function UpdateEmail({
  ...
  const setStatus = () => {
    ...
    if (email === "") {
      ...
      formData.append("remaining_payment_type", email);
    }

    axios
      .post(orderStatusPath, formData)
      .then(({ data }) => {
        updateEmailDisplay[1](false);
  ...
  return (
    <Transition.Root show={updateEmailDisplay[0]} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        initialFocus={cancelButtonRef}
        onClose={updateEmailDisplay[1]}
      >
        <Transition.Child
          as={Fragment}
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                          ...
                          <div className="mt-5">
                            ...
                            >
                              Please add your new email address
                            </label>
                            <input
                              value={email}
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <button
                    ...
                    onClick={() => updateEmailDisplay[1](false)}
                    ref={cancelButtonRef}
                  >
                    Leave
                  </button>
