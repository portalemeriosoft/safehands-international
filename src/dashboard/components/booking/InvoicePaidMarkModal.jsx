...
import { paymentUpdatePath } from "../../../api/path";
import { toast } from "react-toastify";
import { useDispatch } from "react-redux";
import { setNotification } from "../../../store/notificationSlice";

const InvoicePaidMarkModal = ({ 
  isAcceptQuoteOpen, 
    ...
    axios
      ...
      .then(({ data }) => {
        ...
        if (data.status === "success") {
          ...
          dispatch(setNotification(["success", "Payment status updated successfully"]))
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  >
                    {quoteLoading ? "Sending.." : "Yes, Mark as Paid"}
                  </button>
                  <button
                    type="button"
...
export default InvoicePaidMarkModal;
