                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div>
                    <div className="mt-3 text-center sm:mt-0 sm:text-left">
                      ...
                      >
                        Accept Quotation Confirmation
                      </Dialog.Title>

                      <div className="mt-2">
                        <div className="mt-4">
                          <div className="relative">
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400"> Are you sure you want to accept this quotation? Once accepted, the booking process will proceed based on the provided quotation amount. Please confirm to continue.</p>
                          </div>
                        </div>
                      </div>
                    </div>
